		...
		<table class="bord_table" summary="이표는 번호,제목,글쓴이,날자,조회수로 구성되어 있습니다">
			...
			<thead>
				...
				<tr>
					...
					<td align=center><font color="#FFFFFF">A-20%</font></td>
					<td align=center><font color="#FFFFFF">O/X</font></td>
				</tr>
